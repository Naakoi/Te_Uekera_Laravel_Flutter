                                ...
                                <div className="space-y-8">
                                    ...
                                    {progress && (
                                        <div className="w-full bg-gray-200 rounded-full h-2.5 mb-6 overflow-hidden">
                                            <div
                                                className="bg-[#be1e2d] h-2.5 transition-all duration-300 ease-out"
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full py-6 bg-[#be1e2d] text-white font-black rounded-3xl hover:bg-black transition-all shadow-2xl shadow-red-500/20 active:scale-95 disabled:opacity-50 uppercase tracking-[0.2em] text-sm flex items-center justify-center gap-3"
                                        disabled={processing}
                                    >
                                        {processing ? (
                                            <>
                                                ...
                                                <span>Deploying {progress ? `${progress.percentage}%` : '...'}</span>
                                            </>
                                        ) : (
                                            'Execute Publication'
                                        )}
