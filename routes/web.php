...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/logout-others', [ProfileController::class, 'logoutOthers'])->name('profile.logout-others');
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::post('/admin/system-settings', [GatewaySettingController::class, 'updateSystemSetting'])->name('admin.system-settings.update');
